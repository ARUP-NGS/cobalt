...
def test_xratio():
    ...
    xratio = util.x_depth_ratio(regions, depths, min_num_x_regions=3)
    assert xratio == 1.0
...
#     ]
#
#     depths = np.array([10.0, 10.0, 10.0, 10.0, 10.0, 10.0])
#
#     result = util.inflate_x_depths(depths, regions)
#     assert list(result) == [10.0,10.0, 20.0, 20.0, 20.0, 10.0]
#
# def test_inflate_males():
#     regions = [
#         ("1", 10, 20),
#         ("1", 30, 50),
#         ("X", 5, 10),
...
#     ]
#
#     depths = np.matrix([ [10.0, 10.0, 1.0],
#                          [10.0, 10.0, 1.0],
#                          [10.0, 5.0, 0.2],
#                          [10.0, 5.0, 0.5],
#                          [10.0, 4.0, 0.2],
#                          [10.0, 1.0, 0.0]])
#
#     result = util.inflate_male_depths(depths, ["a", "b", "c"], regions)
#
#     assert list(result[:, 0]) == [10.0, 10.0, 10.0, 10.0, 10.0, 10.0]
#     assert list(result[:, 1]) == [10.0, 10.0, 10.0, 10.0, 8.0, 1.0]
#     assert list(result[:, 2]) == [1.0, 1.0, 0.4, 1.0, 0.4, 0.0]
